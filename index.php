...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
     <!-- Favicons -->
    <link href="img/cyrlogo.jpg" rel="icon">
  ...
  ======================================================== -->
    <style>
        .whatsapp-button {
            ...
            z-index: 100; /* Para asegurarte de que esté encima de otros elementos */
        }
...
<body id="top">
<button class="whatsapp-button" onclick="window.open('https://wa.me/1155820489?text=Estoy%20interesado%20en%20sus%20seguros.', '_blank')"><i class="fab fa-whatsapp"></i></button>
 <!-- <a href="https://wa.me/1155820489?text=Estoy%20interesad@%20en%20sus%20seguros" target="_blank"
        ...
        <section id="content" class="s-content">
            ...
            <section id="about" class="s-about target-section">
                <div class="row section-header" data-num="01">
                    <h3 class="column lg-12 section-header__pretitle pretitle text-pretitle">¿Quiénes Somos?</h3>
                    <div class="column lg-6 stack-on-1100 section-header__primary">
                        <h2 class="title text-display-1">
                        Bienvenidos a A&C, tu socio estratégico en seguros con más de 15 años de trayectoria.
                       
                        </h2>
                    </div>
                    <div class="column lg-6 stack-on-1100 section-header__secondary">
                        <p class="desc">
                        Somos un equipo de productores asesores de seguros con amplia experiencia
                        y una sólida alianza con las mejores compañías del mercado..
                        </p>
                    </div>
                ...
                <div class="row process-list list-block show-ctr block-lg-one-half block-tab-whole">
                    <div class="column list-block__item">
                        <div class="list-block__title">
                            <h3 class="h5">Especialización</h3>
                        </div>
                        <div class="list-block__text">
                            <p>
                            Nuestra especialización abarca una amplia gama de riesgos, adaptándonos a las necesidades específicas de cada sector y actividad.
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            Nuestra misión es ser el aliado que necesitas para potenciar tu crecimiento y proteger lo que más valoras. Ofrecemos un asesoramiento experto y personalizado, diseñado para adaptarse a las particularidades de tu negocio, permitiéndote enfocarte en tus proyectos sin preocuparte por los imprevistos.
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            En A&C, nos destacamos por nuestra experiencia, integridad y compromiso con la excelencia. Trabajamos junto a vos para encontrar las soluciones de seguros más adecuadas y ayudarte a alcanzar tus objetivos con la máxima seguridad y tranquilidad. 
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
                    ...
                    <div class="column list-block__item">
                        ...
                        <div class="list-block__text">
                            <p>
                            Estamos aquí para construir contigo un futuro sólido y exitoso. ¡Conéctate con nosotros y descubre cómo nuestra experiencia y conocimiento pueden ser el impulso que tu emprendimiento necesita! 
                            </p>
                        </div>
                    </div> <!-- end list-block__item -->
